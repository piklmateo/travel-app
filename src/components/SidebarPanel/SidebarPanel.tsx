...
const SidebarPanel = () => {
  ...
  return (
    <div className={styles.sidebarPanelContainer}>
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleCloseSidebar} className={isOpen ? styles.closeSidebar : styles.openSidebar} aria-expanded={isOpen}>
        <g>
